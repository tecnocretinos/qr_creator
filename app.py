...
def create_qr_code():
    try:
        ...
        img_url = f"https://kb6y3koqql.execute-api.us-east-1.amazonaws.com/dev/tmp/images/?filename={uuid_id}.png" #. removed
        img.save(img_name)
        logging.exception(os.listdir("/tmp/images"))
        return render_template("show_image.html", qr_code = img_url)
